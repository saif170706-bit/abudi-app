...
import LivestreamBroadcastSheet from '../livestream/LivestreamBroadcastSheet';
import LivestreamPlayerSheet from '../livestream/LivestreamPlayerSheet';
...
export default function AdminLivestreamCard({ livestream, onEdit }: Props) {
  ...
  const handleReset = async () => {
    ...
    if (!firestore) return;
    try {
      // Clear existing recording data and generate a fresh session ID for a clean start
