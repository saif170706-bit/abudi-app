  ...
  return (
    ...
    >
      ...
      <View className="flex-1">
        <Text className="mb-0.5 text-[9px] font-black uppercase tracking-[0.2em] text-accent">{tGlobal('Fortsæt læsning')}</Text>
        <Text className="text-base font-black leading-tight text-foreground">
          {tGlobal('Side')} {page} {tGlobal('i Quran')}
        </Text>
        <Text className="mt-0.5 text-[10px] font-bold text-muted-foreground">{tGlobal('Tryk for at fortsætte')}</Text>
      </View>
